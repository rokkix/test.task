...
<head>
    ...
    <link rel="stylesheet" href="App/Views/admin/css/styles.min.css" />
    <script src="App/Views/admin/js/jquery-1.8.3.min.js"></script>
	<script src="App/Views/admin/js/script.js"></script>
...
<body>
    <header class="header">
        <div class="header__inner">
			...
			<a href="/?act=showpanel&ctrl=admin"><img class=""  alt="Управление" /></a>
        ...
        <aside class="sidebar">
            <form class="sidebar__form" method="get" action="">
                ...
                <div class="form__holder">
                  <input class="form__input form__input_margin_left" id="price" type="text" value="0" name="pricel"/><span class="form__label">-</span>
                    <input class="form__input form__input_margin_right" type="text" value="20000" name="pricer" /><span class="form__label">$</span>
                </div>
                <div class="form__expand" id="hiddenContent">
                    ...
                    <select class="form__select" name="korobka" id="transmission">
                        ...
                        <?php foreach ($groupTransmissions as $groupTransmission) : ?>	
							<option value="<?php echo $groupTransmission->korobka?>"><?php echo $groupTransmission->korobka ?></option>
						<?php endforeach; ?>
                    </select>
            ...
            <div class="sidebar__brands">
				...
				<?php foreach ($modelGroups as $modelGroup) : ?>	
						 <li class="sidebar__item" id = <?php echo $modelGroup->name?>><?php echo $modelGroup->name?> (<?php echo $modelGroup->groupmodel?>)</li>
				<?php endforeach; ?>
						 ...
						 <?php foreach ($pages as $page) : ?>	
							<li class="catalog__item">
								<a class="catalog__image" href="#">
									...
									<?php if (file_exists(__DIR__ . '/../images/' . $page->id . '.jpeg')): ?>
								...
								<div class="catalog__description">
									...
									<a class="catalog__model" href="/?act=One&ctrl=admin&id=<?php echo $page->id?>"><?php echo $page->name .' '. $page->model ; ?></a>
